...
// Size of a chunk inside the raw hardware channel
#define NALLATECH_RAW_CHUNK_BYTES 32
#define NALLATECH_RAW_CHUNK_WORDS (NALLATECH_RAW_CHUNK_BYTES / sizeof(NALLATECH_WORD))

#define NALLATECH_NUM_WRITE_WINDOWS 3
#define NALLATECH_NUM_READ_WINDOWS 4
